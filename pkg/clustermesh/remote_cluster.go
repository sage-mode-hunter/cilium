...
type remoteCluster struct {
	...
	clusterMeshServiceV2 cmtypes.ClusterMeshServiceV2Mode
...
func (rc *remoteCluster) Status() *models.RemoteCluster {
	...
	status.Synced = &models.RemoteClusterSynced{
		...
		Services:  !rc.clusterMeshServiceV2.WatchLegacyServices() || rc.remoteServices.Synced(),
...
func newSynced() synced {
	...
	return synced{
		...
		// as sync if they are not watch. Thus, we use stoppable wait groups
